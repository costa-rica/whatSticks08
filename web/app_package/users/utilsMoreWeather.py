...
#                 dates_call_dict[call_period] = {"start": temp_start_str, "end":temp_end_str}
#                 logger_users.info('- First dates_call_dict entry: len(dates_call_dict) ==0 - ')
#                 logger_users.info(dates_call_dict[call_period])
...
#                 if temp_end_str != dates_call_dict[call_period-1].get('end'):
#                     dates_call_dict[call_period] = {"start": temp_start_str, "end":temp_end_str}                  
#                     logger_users.info('- After first dates_call_dict - ')
#                     logger_users.info(dates_call_dict[call_period])
